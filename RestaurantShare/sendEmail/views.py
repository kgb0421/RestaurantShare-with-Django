...
def sendEmail(request):
    ...
    msg = EmailMessage(subject = inputTitle, body = msg_html, from_email = "diakt0421@gmail.com", bcc = inputReceiver.split(','))
...
"""
    ...
    server.login("diakt0421@gmail.com", "!diakt9078")

    msg = MIMEMultipart('alternative')
    msg['Subject'] = inputTitle
    msg['From'] = "diakt0421@gmail.com"
